...
export type CreatePropertyMutation = (
  ...
  & { createProperty: (
    { __typename?: 'Property' }
    & Pick<Property, 'id' | 'title' | 'propertyType' | 'mainImage' | 'description' | 'pricePerNight' | 'latitude' | 'longitude' | 'amenities' | 'createdAt' | 'updatedAt'>
    & { reviews?: Maybe<Array<(
      { __typename?: 'Review' }
...
export type PropertiesQuery = (
  ...
  & { properties: Array<(
    { __typename?: 'Property' }
    & Pick<Property, 'id' | 'title' | 'propertyType' | 'mainImage' | 'latitude' | 'longitude' | 'amenities' | 'pricePerNight'>
    & { reviews?: Maybe<Array<(
      { __typename?: 'Review' }
      & Pick<Review, 'id' | 'title' | 'body'>
      & { user: (
        { __typename?: 'User' }
        & Pick<User, 'id' | 'picture' | 'createdAt' | 'fullName'>
      ) }
    )>>, propertyCreator: (
      { __typename?: 'User' }
