...
export class init1624715213982 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "reviews" ("id" SERIAL NOT NULL, "creatorId" integer NOT NULL, "title" character varying(40) NOT NULL, "body" character varying(360) NOT NULL, CONSTRAINT "PK_231ae565c273ee700b283f15c1d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
