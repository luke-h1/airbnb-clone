...
export type CreatePropertyMutation = (
  ...
  & { createProperty: (
    ...
    & { errors?: Maybe<Array<(
      ...
      { __typename?: 'Property' }
      & Pick<Property, 'id' | 'title' | 'propertyType' | 'mainImage' | 'description' | 'pricePerNight' | 'address' | 'amenities' | 'createdAt' | 'updatedAt'>
      & { creator: (
        { __typename?: 'User' }
...
export type UpdatePropertyMutation = (
  ...
  & { updateProperty?: Maybe<(
    { __typename?: 'Property' }
    & Pick<Property, 'id' | 'title' | 'propertyType' | 'mainImage' | 'description' | 'address' | 'amenities' | 'createdAt' | 'updatedAt'>
    & { creator: (
      { __typename?: 'User' }
