...
export class initProdMigration1627739428140 implements MigrationInterface {
  name = 'initProdMigration1627739428140';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "properties" ("id" SERIAL NOT NULL, "title" character varying(30) NOT NULL, "creatorId" integer NOT NULL, "propertyType" character varying(30) NOT NULL, "image" character varying NOT NULL, "imageFileName" character varying NOT NULL, "beds" integer NOT NULL, "bedrooms" integer NOT NULL, "description" character varying NOT NULL, "pricePerNight" integer NOT NULL, "address" character varying(50) NOT NULL, "amenities" text array NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2d83bfa0b9fcd45dee1785af44d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
